...
def model_worker():
    ...
    while True:
        ...
        try:
            ...
            result_queue.put(None)  # Put None to avoid blocking
...
def main():
    ...
    detection_cooldown = 5  # Minimum seconds between detections
    ...
    try:
        while True:
            ...
            if not result_queue.empty():
                ...
                if result is None:  # Skip if inference failed
                    continue
                ...
                for bbox, confi, cls in zip(bboxes, confidences, classes):
                    ...
                    # Handle detection of infected plants
